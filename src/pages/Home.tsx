        ...
        <div className="w-128 h-full alta-play-bg alta-min-height-full fixed flex flex-col gap-6 py-4">
          ...
          <div className="w-112 flex flex-col gap-2 my-0 mx-auto">
            <div className="flex items-center h-10 cursor-pointer group">
              ...
              <p className="text-gray-500 text-sm flex-grow bg-gray-200 group-hover:bg-gray-300 group-hover:text-gray-600 pl-5 h-full flex items-center font-semibold josefin-font rounded-tr-md rounded-br-md">Release</p>
            </div>
            <div className="flex items-center h-10 cursor-pointer group">
              ...
              <p className="text-gray-500 text-sm flex-grow bg-gray-200 group-hover:bg-gray-300 group-hover:text-gray-600 pl-5 h-full flex items-center font-semibold josefin-font rounded-tr-md rounded-br-md">C:\Games\Alta\A Township Tale</p>
            </div>
            <div className="flex items-center h-10 cursor-pointer group">
              ...
              <p className="text-gray-500 text-sm flex-grow bg-gray-200 group-hover:bg-gray-300 group-hover:text-gray-600 pl-5 h-full flex items-center font-semibold josefin-font rounded-tr-md rounded-br-md">SteamVR</p>
            </div>
          </div>

          <div className="w-112 mx-auto my-0">
            <p className="text-sm alta-white josefin-font">Version: main-0.0.78.8</p>
            <p className="text-sm alta-white josefin-font">Target Directory: C:\Games\Alta\A Township Tale</p>
          </div>

          <div className="flex w-112 my-0 mx-auto items-center justify-between">
            <button onClick={handlePlay} className="w-88 py-2 font-bold text-lg bg-blue-500 rounded-md alta-white">Play</button>
